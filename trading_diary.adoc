...
Decided to close the IBB position. This strategy needs to be examined later, in more details.



// for bibliography test: Testing referencing of bibliography <<bibliography.adoc#taoup, Art of Unix Programming>>
