...
Like commodities, all property investment represents a real asset. Property, because of the pattern of cashflows involved, tends to produce a high and stable cashflow. However, it does not normally offer the possibility of rapid capital apprecciation [spelling!!].  
