...
I am indebted to the authors of [this cribsheet]http://asciidoctor.org/docs/asciidoc-syntax-quick-reference/ footnote:[I've never actually used or installed asciidoctor - I just use the asciidoc processor that comes with gitbook] and also http://www.methods.co.nz/asciidoc/userguide.html[this one].
