...
Many studies have shown that a chimp with a dartboard has a pretty good chance of 
picking stocks better than the average fund manager. 
Nevertheless, most British savers choose to hand over their savings to a professional.
